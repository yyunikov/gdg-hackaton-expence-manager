...
/**
 * @see <a href="https://github.com/ikimuhendis/LDrawer/blob/master/library/src/main/java/com/ikimuhendis/ldrawer/ActionBarDrawerToggle.java">original source on GitHub</a>
 */
public class ActionBarDrawerToggle extends android.support.v4.app.ActionBarDrawerToggle {
    ...
    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, DrawerArrowDrawable drawerImage, int openDrawerContentDescRes, int closeDrawerContentDescRes) {
        super(activity, drawerLayout, R.drawable.ic_ab_drawer, openDrawerContentDescRes, closeDrawerContentDescRes);
        mActivity = activity;
