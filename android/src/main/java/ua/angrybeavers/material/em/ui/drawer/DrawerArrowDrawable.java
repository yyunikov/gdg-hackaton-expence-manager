...
public abstract class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        this.mPaint.setColor(context.getResources().getColor(R.color.drawer_color));
        this.mSize = context.getResources().getDimensionPixelSize(R.dimen.drawer_drawable_size);
        this.mBarSize = context.getResources().getDimensionPixelSize(R.dimen.drawer_bar_size);
        this.mTopBottomArrowSize = context.getResources().getDimensionPixelSize(R.dimen.drawer_top_bottom_bar_arrow_size);
        this.mBarThickness = context.getResources().getDimensionPixelSize(R.dimen.drawer_thickness);
        this.mBarGap = context.getResources().getDimensionPixelSize(R.dimen.drawer_gap_between_bars);
        this.mMiddleArrowSize = context.getResources().getDimensionPixelSize(R.dimen.drawer_middle_bar_arrow_size);
